    ...
    <form method="post" action="{{url('update-developer-management')}}" enctype="multipart/form-data">
        ...
        <div class="wrapper">
            ...
            <div class="row">
                <div class="col-xl-2 col-md-2 m-b-10px">
                    <div class="form-group">
                        <img id="blah2" style="margin-bottom:5px;border:solid 1px #c2cad8;" width="100%" height="150" src="{{ url('/pictures/'.$data['user']->picture) }}" onerror="this.src='{{ env('DEVELOPER_URL') }}/apps/{{ $data['user']->picture }}';"/><br>
