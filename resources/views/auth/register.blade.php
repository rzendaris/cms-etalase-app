                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <!-- <input id="dev_country_id" type="text" class="form-control @error('dev_country_id') is-invalid @enderror" name="dev_country_id" value="{{ old('name') }}" required autocomplete="dev_country_id" autofocus> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dev_address" type="text" class="form-control @error('dev_address') is-invalid @enderror" name="dev_address" value="{{ old('name') }}" required autocomplete="dev_address" autofocus>
