                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-md-5 m-b-10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" class="form-control" value="Name" required/>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">Website :*</label>
                                    <input type="text" name="website" class="form-control" value="ubisoft.com"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label">Password :</label>
                                    <input type="password" name="Password" class="form-control date" value="qwe123"/>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-xl-5 col-md-5 m-b-10px">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" value="ubisoft@gmail.com"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="textarea-register form-control" rows="5">Jalan No 15</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
